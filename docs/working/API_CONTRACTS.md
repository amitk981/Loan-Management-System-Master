...
## Loan document generation and metadata list (008B, authority boundary closed by 008B2)
...
format, execution/verification/stamp/notary states, and creation time. It exposes no rendered merge
