...
def approve_case(*, actor, case_id, payload, actor_permissions, request_meta=None):
    return approval_actions.approve_case(
        actor=actor,
        case_id=case_id,
        payload=payload,
        actor_permissions=actor_permissions,
        request_meta=request_meta,
        sanction_completion_hook=_create_document_checklist,
    )


def _create_document_checklist(*, actor, application_id, sanction_decision_id):
