...
def resolve_current_stage4_target(*, actor, permission, loan_document_id, for_update=False):
    ...
    if loan_document.renderer_validation_status != LoanDocument.RENDERER_CURRENT_VALIDATED:
