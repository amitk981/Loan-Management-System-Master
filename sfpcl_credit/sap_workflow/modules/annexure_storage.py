...
class EncryptedAnnexureStorage:
    ...
    def store(self, uploaded_file):
        ...
        encrypted_upload = SimpleUploadedFile(uploaded_file.name, ciphertext, content_type="application/octet-stream")
    ...
    def read_verified(self, document):
        ...
        try:
            encoded = FieldEncryption.decrypt(_ENCRYPTION_CONTEXT, token.decode("ascii"))
