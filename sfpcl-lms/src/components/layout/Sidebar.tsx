...
const allNavItems: NavItem[] = [
  ...
  { id: 'interest',      label: 'Interest Management',   icon: <Percent size={18} />,         requiredPermission: 'post_repayment' },
  ...
  { id: 'closure',       label: 'Closure & Archive',     icon: <BadgeCheck size={18} />,      requiredPermission: 'manage_documentation' },
...
const borrowerNavItems: NavItem[] = [
  ...
  { id: 'applicationData', label: 'Application Data',    icon: <ClipboardList size={18} /> },
  { id: 'repayments',      label: 'Repayments',          icon: <ReceiptIndianRupee size={18} /> },
  { id: 'documents',       label: 'My Documents',        icon: <FileCheck size={18} /> },
  { id: 'loanHistory',     label: 'Loan History',         icon: <History size={18} /> },
