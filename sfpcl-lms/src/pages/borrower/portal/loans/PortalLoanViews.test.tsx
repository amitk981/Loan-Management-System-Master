...
const instructions: portalApi.PortalDirectRepaymentInstructions = { available: true, beneficiary_name: 'SFPCL Collections', bank_name: 'Approved Bank', account_number_masked: '********4321', ifsc: 'APPR0001234', required_narration: 'LN-PORTAL-001', amount_due: '305000.00', proof_submission_enabled: false, disclaimer: 'Repayment updates after verification and posting.' };
