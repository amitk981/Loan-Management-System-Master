...
const ReportsMIS: React.FC = () => {
  ...
  const tabs: { id: ReportTab; label: string }[] = [
    ...
    { id: 'dpd',        label: 'DPD & Ageing Analysis' },
      ...
      {activeTab === 'portfolio' && (
        <div className="space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6">
            <h3 className="font-semibold text-slate-900 mb-4">Disbursement by member type</h3>
                ...
                <div key={row.month} className="flex items-center gap-4">
                  ...
                  <div className="flex-1 bg-slate-100 rounded-full h-6 relative overflow-hidden">
                    <div
                      ...
                      style={{ width: `${(row.amount / 3500000) * 100}%` }}
                    >
        ...
        <div className="space-y-5">
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-100">
              ...
              <p className="text-xs text-slate-500 mt-0.5">Days past due ageing by outstanding amount.</p>
            </div>
