...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-13_055322_architecture_review/sfpcl-lms

 ✓ src/pages/members/MemberProfile.container.test.tsx (4 tests) 279ms
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 798ms
 ...
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1372ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 1982ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1018ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  754ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 3647ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  3182ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (15 tests) 6955ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback before an ordinary update readback  3038ms
   ✓ MemberGovernanceForm production container > submits the complete individual_farmer body through the shared HTTP transport  1136ms
 ...
 Test Files  29 passed (29)
   ...
   Start at  06:10:10
   Duration  10.41s (transform 5.15s, setup 0ms, collect 7.75s, tests 17.04s, environment 2.40s, prepare 1.66s)
