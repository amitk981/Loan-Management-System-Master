...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 916ms
   ✓ MP05 loan-limit display authority (006Z2 interim regression) > shows independent 400, 403, and 409 errors without retry or projection refetch  581ms
 ✓ src/pages/settings/SettingsHub.test.tsx (10 tests) 1235ms
 ...
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (10 tests) 1338ms
   ✓ mounted witness resource actions > captures with the exact body and refetches the canonical collection once  519ms
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1617ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2280ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1157ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  855ms
 ✓ src/pages/registers/RegistersHub.test.tsx (7 tests) 558ms
 ...
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (25 tests) 2751ms
   ✓ SanctionWorkbench authenticated container > loads frozen case truth and approves through the exact case boundary before canonical refresh  377ms
 ...
 ✓ src/services/authSession.test.ts (27 tests) 28ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2533ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2174ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 3267ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  1986ms

 Test Files  33 passed (33)
      Tests  269 passed (269)
   Start at  06:38:47
   Duration  6.36s (transform 4.65s, setup 0ms, collect 8.96s, tests 17.64s, environment 3.40s, prepare 2.04s)
