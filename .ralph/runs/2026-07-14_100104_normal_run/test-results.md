...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-14_100104_normal_run/sfpcl-lms

 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 980ms
 ...
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (10 tests) 1335ms
   ✓ mounted witness resource actions > captures with the exact body and refetches the canonical collection once  448ms
 ✓ src/pages/settings/SettingsHub.test.tsx (10 tests) 1335ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2314ms
 ...
 ✓ src/pages/registers/RegistersHub.test.tsx (8 tests) 656ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2901ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2429ms
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (39 tests) 4860ms
   ...
   ✓ SanctionWorkbench authenticated container > uploads three application-scoped legal files before recording bounded special-case evidence  478ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 3406ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  2047ms

 Test Files  33 passed (33)
      Tests  293 passed (293)
   Start at  10:22:38
   Duration  6.77s (transform 5.46s, setup 0ms, collect 9.72s, tests 20.67s, environment 3.77s, prepare 2.16s)
