...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (4 tests) 162ms
 ...
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (10 tests) 956ms
 ...
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1317ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 1897ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  937ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  748ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 3234ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2751ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (15 tests) 6954ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback before an ordinary update readback  3016ms
   ✓ MemberGovernanceForm production container > submits the complete individual_farmer body through the shared HTTP transport  1122ms
   ✓ MemberGovernanceForm production container > submits the complete fpc body through the shared HTTP transport  958ms
   ✓ MemberGovernanceForm production container > submits the complete producer_institution body through the shared HTTP transport  1103ms

 Test Files  29 passed (29)
      Tests  204 passed (204)
   Start at  02:17:50
   Duration  10.04s (transform 4.45s, setup 0ms, collect 7.26s, tests 15.58s, environment 2.16s, prepare 1.73s)
