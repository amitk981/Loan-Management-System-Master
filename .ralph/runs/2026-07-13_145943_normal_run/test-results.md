...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 3110ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2106ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is explicit false  542ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > exposes only approved staff demo controls when the flag is true  462ms
 ...
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (10 tests) 1057ms
   ✓ mounted witness resource actions > captures with the exact body and refetches the canonical collection once  362ms
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1442ms
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 1759ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1000ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  625ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 2511ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  1316ms

 Test Files  29 passed (29)
      Tests  208 passed (208)
   Start at  15:35:03
   Duration  6.59s (transform 4.32s, setup 0ms, collect 8.18s, tests 12.06s, environment 2.44s, prepare 1.86s)
