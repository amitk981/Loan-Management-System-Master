...
- docs/slices/003F-communication-template-shell.md
- docs/slices/003G-dashboard-task-summary-api.md
- docs/slices/003H-dashboard-task-ui-wiring.md
...
- sfpcl_credit/tests/test_content_templates_api.py
