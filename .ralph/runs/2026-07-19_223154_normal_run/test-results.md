...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-19_223154_normal_run/sfpcl-lms
 ...
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 1107ms
   ✓ MP05 loan-limit display authority (006Z2 interim regression) > shows independent 400, 403, and 409 errors without retry or projection refetch  638ms
 ✓ src/pages/settings/SettingsHub.test.tsx (10 tests) 1493ms
 ...
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1995ms
 ...
 ✓ src/pages/borrower/portal/disbursement/MP14_DisbursementStatus.test.tsx (6 tests) 307ms
 ✓ src/pages/documentation/DocumentationHub.test.tsx (18 tests) 2743ms
   ✓ 008M2 documentation workspace contract > posts a server-owned approval and refetches once without optimism  580ms
   ✓ 008M2 documentation workspace contract > keeps a conflict visible with no optimistic change, retry, or refetch  488ms
   ✓ 008M2 documentation workspace contract > submits a signed-copy upload through the opaque action and refetches once  439ms
 ...
 ✓ src/pages/borrower/portal/PortalMemberViews.test.tsx (6 tests) 229ms
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2568ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1194ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  1082ms
 ...
 ✓ src/pages/disbursement/PaymentAuthorisationHub.test.tsx (5 tests) 1113ms
   ...
   ✓ 009K CFC payment authorisation workspace > surfaces backend duplicate UTR and permission errors without optimistic success  396ms
 ✓ src/pages/disbursement/DisbursementHub.test.tsx (4 tests) 395ms
 ✓ src/pages/loan-accounts/LoanAccount360.test.tsx (4 tests) 392ms
 ...
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (39 tests) 6194ms
   ...
   ✓ SanctionWorkbench authenticated container > keeps a newer filter authoritative while an action decision refresh finishes  445ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 5121ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  2689ms
   ✓ MemberGovernanceForm production container > submits the complete individual_farmer body through the shared HTTP transport  312ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 1138ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  1033ms

 Test Files  43 passed (43)
      Tests  355 passed (355)
   Start at  22:52:38
   Duration  9.24s (transform 4.56s, setup 0ms, collect 13.77s, tests 29.56s, environment 6.80s, prepare 2.90s)


Duration milliseconds: 10066
Exit code: 0
