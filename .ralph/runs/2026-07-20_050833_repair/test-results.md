...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 ✓ src/pages/settings/SettingsHub.test.tsx (10 tests) 1294ms
   ...
   ✓ SettingsHub remaining panels > creates a complete successor as a separate audited draft for a canonical policy manager  313ms
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (10 tests) 1273ms
   ✓ mounted witness resource actions > captures with the exact body and refetches the canonical collection once  449ms
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1817ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2513ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1233ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  978ms
 ✓ src/pages/documentation/DocumentationHub.test.tsx (18 tests) 2528ms
 ...
 ✓ src/pages/registers/RegistersHub.test.tsx (8 tests) 782ms
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 950ms
 ...
 ✓ src/pages/disbursement/PaymentAuthorisationHub.test.tsx (5 tests) 1165ms
   ...
   ✓ 009K CFC payment authorisation workspace > surfaces backend duplicate UTR and permission errors without optimistic success  475ms
 ...
 ✓ src/pages/borrower/portal/documents/PortalDocumentationActions.test.tsx (8 tests) 568ms
 ...
 ✓ src/pages/loan-accounts/LoanAccount360.test.tsx (4 tests) 185ms
 ✓ src/pages/borrower/portal/PortalMemberViews.test.tsx (6 tests) 150ms
 ...
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (39 tests) 5410ms
   ...
   ✓ SanctionWorkbench authenticated container > uploads three application-scoped legal files before recording bounded special-case evidence  532ms
 ...
 ✓ src/services/authSession.test.ts (36 tests) 32ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 4473ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  2257ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2423ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2103ms
 ✓ src/playwrightBrowser.test.ts (4 tests) 2ms

 Test Files  43 passed (43)
      Tests  355 passed (355)
   Start at  05:25:36
   Duration  8.08s (transform 4.59s, setup 0ms, collect 12.09s, tests 27.82s, environment 6.10s, prepare 2.47s)


Duration milliseconds: 8610
Exit code: 0
