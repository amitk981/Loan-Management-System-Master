...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-13_094017_normal_run/sfpcl-lms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2757ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  1920ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is explicit false  499ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > exposes only approved staff demo controls when the flag is true  337ms
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 966ms
   ✓ MP05 loan-limit display authority (006Z2 interim regression) > shows independent 400, 403, and 409 errors without retry or projection refetch  557ms
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (10 tests) 1044ms
   ✓ mounted witness resource actions > captures with the exact body and refetches the canonical collection once  334ms
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1348ms
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 1745ms
   ...
   ✓ MemberGovernanceForm > submits every individual registration profile field  593ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 2489ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  1312ms

 Test Files  29 passed (29)
      Tests  208 passed (208)
   Start at  10:05:36
   Duration  6.36s (transform 3.97s, setup 0ms, collect 7.60s, tests 11.58s, environment 2.47s, prepare 1.88s)
