...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 ✓ src/pages/repayments/RepaymentsHub.test.tsx (9 tests) 1618ms
   ✓ 010MA Repayments Hub wiring > posts one governed direct attempt, displays backend allocation, and refreshes reads  516ms
   ✓ 010MA Repayments Hub wiring > shows backend posting denial without retry or canonical refresh: AuthSessionError: Amount must be a positive decimal.  313ms
 ...
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1780ms
   ✓ default AppraisalWorkbench authenticated HTTP container > calculates a limit from entered source IDs and refreshes four reads  302ms
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2231ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1127ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  838ms
 ✓ src/pages/documentation/DocumentationHub.test.tsx (18 tests) 2508ms
   ✓ 008M2 documentation workspace contract > posts a server-owned approval and refetches once without optimism  497ms
   ✓ 008M2 documentation workspace contract > keeps a conflict visible with no optimistic change, retry, or refetch  426ms
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 961ms
   ✓ MP05 loan-limit display authority (006Z2 interim regression) > shows independent 400, 403, and 409 errors without retry or projection refetch  503ms
 ✓ src/pages/settings/SettingsHub.test.tsx (10 tests) 1341ms
   ✓ SettingsHub Approval Matrix panel > permits a canonical manager to submit a complete successor version as a pending proposal  565ms
   ✓ SettingsHub remaining panels > creates a complete successor as a separate audited draft for a canonical policy manager  398ms
 ✓ src/pages/disbursement/PaymentAuthorisationHub.test.tsx (5 tests) 1200ms
 ...
 ✓ src/pages/registers/RegistersHub.test.tsx (8 tests) 723ms
 ✓ src/pages/defaults/DefaultRecoveryHub.test.tsx (1 test) 678ms
   ✓ 011F recovery execution surface > uses the approved backend action and uploaded evidence to initiate S57  677ms
 ✓ src/pages/borrower/portal/documents/PortalDocumentationActions.test.tsx (8 tests) 550ms
 ...
 ✓ src/pages/servicing/InterestMonitoringWorkspaces.test.tsx (6 tests) 441ms
 ✓ src/pages/search/GlobalSearchResults.test.tsx (5 tests) 640ms
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (39 tests) 5839ms
   ✓ SanctionWorkbench authenticated container > renders the authoritative total and replaces the queue from the next server page  532ms
   ...
   ✓ SanctionWorkbench authenticated container > loads frozen case truth and approves through the exact case boundary before canonical refresh  383ms
   ✓ SanctionWorkbench authenticated container > requires a reason and sends the exact Reject request  438ms
   ✓ SanctionWorkbench authenticated container > requires a reason and sends the exact Return for Clarification request  374ms
   ✓ SanctionWorkbench authenticated container > uploads three application-scoped legal files before recording bounded special-case evidence  750ms
 ✓ src/pages/loan-accounts/LoanAccount360.test.tsx (6 tests) 368ms
 ...
 ✓ src/pages/borrower/portal/loans/PortalLoanViews.test.tsx (6 tests) 354ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 4663ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  2408ms
   ✓ MemberGovernanceForm production container > posts only the protected identity delta through the shared HTTP transport  341ms
 ...
 ✓ src/components/layout/Header.search.test.tsx (1 test) 252ms
 ✓ src/pages/borrower/portal/PortalMemberViews.test.tsx (6 tests) 199ms
 ✓ src/services/portalApi.test.ts (9 tests) 23ms
 ✓ src/pages/applications/ApplicationDetail.test.tsx (9 tests) 117ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2173ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2058ms

 Test Files  52 passed (52)
      Tests  413 passed (413)
   Start at  20:29:39
   Duration  10.10s (transform 4.95s, setup 0ms, collect 14.98s, tests 32.83s, environment 8.69s, prepare 3.22s)


Duration milliseconds: 10644
Exit code: 0
