...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-14_081204_normal_run/sfpcl-lms

 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 1140ms
   ✓ MP05 loan-limit display authority (006Z2 interim regression) > shows independent 400, 403, and 409 errors without retry or projection refetch  718ms
 ...
 ✓ src/pages/settings/SettingsHub.test.tsx (10 tests) 1436ms
   ✓ SettingsHub Approval Matrix panel > permits a canonical manager to submit a complete successor version as a pending proposal  695ms
 ...
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1805ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2521ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1285ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  969ms
 ...
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (33 tests) 3317ms
   ...
   ✓ SanctionWorkbench authenticated container > requires a reason and sends the exact Reject request  419ms
   ✓ SanctionWorkbench authenticated container > requires a reason and sends the exact Return for Clarification request  324ms
   ✓ SanctionWorkbench authenticated container > uploads three application-scoped legal files before recording bounded special-case evidence  588ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2620ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2195ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 3385ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  2019ms

 Test Files  33 passed (33)
      Tests  287 passed (287)
   Start at  08:38:52
   Duration  6.61s (transform 5.09s, setup 0ms, collect 9.63s, tests 19.42s, environment 3.70s, prepare 1.94s)
