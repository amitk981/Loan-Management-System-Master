...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-14_193053_normal_run/sfpcl-lms

 ✓ src/pages/registers/RegistersHub.test.tsx (8 tests) 796ms
   ✓ RegistersHub owned approval register panels > applies only canonical financial-year values  301ms
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 962ms
 ...
 ✓ src/pages/settings/SettingsHub.test.tsx (10 tests) 1297ms
 ...
 ✓ src/pages/members/MemberProfile.container.test.tsx (4 tests) 258ms
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2368ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1273ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  846ms
 ...
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (10 tests) 1151ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2848ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2331ms
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (39 tests) 4913ms
   ✓ SanctionWorkbench authenticated container > renders the authoritative total and replaces the queue from the next server page  420ms
   ...
   ✓ SanctionWorkbench authenticated container > uploads three application-scoped legal files before recording bounded special-case evidence  384ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 3441ms
 ...
 Test Files  33 passed (33)
   ...
   Start at  20:07:30
   Duration  6.85s (transform 5.58s, setup 0ms, collect 10.16s, tests 20.57s, environment 4.05s, prepare 2.03s)
