...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-13_164911_architecture_review/sfpcl-lms
 ...
 ✓ src/pages/appraisal/AppraisalWorkbench.test.tsx (22 tests) 272ms
 ...
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (2 tests) 17ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 3207ms
   ...
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is explicit false  460ms
 ...
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 866ms
 ...
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (10 tests) 1085ms
   ✓ mounted witness resource actions > captures with the exact body and refetches the canonical collection once  399ms
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1333ms
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 1785ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1040ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  613ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 2573ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  1306ms

 Test Files  29 passed (29)
      Tests  208 passed (208)
   Start at  17:08:06
   Duration  6.79s (transform 4.60s, setup 0ms, collect 8.33s, tests 12.32s, environment 2.78s, prepare 1.83s)
