...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 ✓ src/services/authSession.test.ts (15 tests) 22ms
 ...
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (2 tests) 8ms
 ✓ src/pages/members/MemberProfile.container.test.tsx (1 test) 22ms
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2319ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  1939ms
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (4 tests) 573ms
   ✓ mounted witness resource actions > captures with the exact body and refetches the canonical collection once  353ms
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 945ms
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (4 tests) 1226ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  733ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  403ms

 Test Files  28 passed (28)
      Tests  177 passed (177)
   Start at  17:51:50
   Duration  3.73s (transform 2.79s, setup 0ms, collect 5.36s, tests 6.02s, environment 1.45s, prepare 1.87s)
