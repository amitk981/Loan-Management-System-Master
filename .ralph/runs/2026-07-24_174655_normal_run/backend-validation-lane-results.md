...
- Selection reason: periodic full-suite checkpoint at completed slice 348
- Enforcement policy: selective
- Slice risk: high
- Candidate completion ordinal: 348
- Impacted-test workers: 6

Backend changed paths:
- `sfpcl_credit/config/production_settings.py`
- `sfpcl_credit/config/settings.py`
- `sfpcl_credit/identity/modules/tokens.py`
- `sfpcl_credit/security_regression/__init__.py`
- `sfpcl_credit/security_regression/lane.py`
- `sfpcl_credit/security_regression/matrix.py`
- `sfpcl_credit/security_regression/runner.py`
- `sfpcl_credit/security_regression/scanners.py`
- `sfpcl_credit/shared/management/commands/security_regression.py`
- `sfpcl_credit/tests/test_field_encryption.py`
- `sfpcl_credit/tests/test_production_demo_isolation.py`
- `sfpcl_credit/tests/test_security_regression.py`

Impacted test labels:
- `sfpcl_credit.tests.test_field_encryption`
- `sfpcl_credit.tests.test_production_demo_isolation`
- `sfpcl_credit.tests.test_security_regression`
