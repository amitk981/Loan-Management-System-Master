...
................................................................................sssssss.....ssssss.........ssss..sssss.....ssssssss.........ssss........sssssssssE..........ssss.....sssss..........
======================================================================
ERROR: test_forward_and_reverse_transfer_preserve_exact_business_state (sfpcl_credit.tests.test_sap_model_ownership_migration.SapModelOwnershipMigrationTests.test_forward_and_reverse_transfer_preserve_exact_business_state)
----------------------------------------------------------------------
Traceback (most recent call last):
  ...
  File "/Users/amitkallapa/LMS/.ralph/venv/lib/python3.11/site-packages/django/db/backends/sqlite3/base.py", line 329, in execute
    return super().execute(query, params)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
sqlite3.OperationalError: no such table: sap_customer_codes

The above exception was the direct cause of the following exception:

Traceback (most recent call last):
  File "/Users/amitkallapa/LMS/.ralph/worktrees/2026-07-16_190027_normal_run/sfpcl_credit/tests/test_sap_model_ownership_migration.py", line 105, in setUp
    self.identifiers = self._create_finance_owned_rows(self.old_apps)
                       ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/amitkallapa/LMS/.ralph/worktrees/2026-07-16_190027_normal_run/sfpcl_credit/tests/test_sap_model_ownership_migration.py", line 288, in _create_finance_owned_rows
