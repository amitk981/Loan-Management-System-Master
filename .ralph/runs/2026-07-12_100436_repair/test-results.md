...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 ✓ src/pages/applications/CompletenessWorkbench.test.tsx (5 tests) 132ms
 ✓ src/pages/members/Borrower360.test.tsx (4 tests) 130ms
 ✓ src/pages/applications/ApplicationDetail.test.tsx (9 tests) 149ms
 ✓ src/pages/members/MemberProfile.test.tsx (26 tests) 285ms
 ✓ src/pages/appraisal/AppraisalWorkbench.test.tsx (22 tests) 264ms
 ...
 ✓ src/services/authSession.test.ts (15 tests) 39ms
 ...
 ✓ src/services/tracerApi.test.ts (2 tests) 13ms
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (2 tests) 4ms
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2207ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2047ms
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (3 tests) 578ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  476ms
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 962ms

 Test Files  26 passed (26)
      Tests  171 passed (171)
   Start at  10:11:00
   Duration  3.68s (transform 2.85s, setup 0ms, collect 5.38s, tests 5.12s, environment 694ms, prepare 1.71s)
