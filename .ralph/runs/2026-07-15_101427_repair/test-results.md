...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 1142ms
   ✓ MP05 loan-limit display authority (006Z2 interim regression) > creates, submits exactly once, and canonically refetches the returned amount  344ms
 ...
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (10 tests) 1286ms
   ✓ mounted witness resource actions > captures with the exact body and refetches the canonical collection once  423ms
 ✓ src/pages/settings/SettingsHub.test.tsx (10 tests) 1371ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2648ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1373ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  988ms
 ...
 ✓ src/pages/borrower/portal/documents/PortalDocumentationActions.test.tsx (5 tests) 467ms
...
(node:83683) ExperimentalWarning: buffer.File is an experimental feature and might change at any time
(Use `node --trace-warnings ...` to show where the warning was created)
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2435ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2149ms
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (39 tests) 5488ms
   ✓ SanctionWorkbench authenticated container > renders the authoritative total and replaces the queue from the next server page  477ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 3794ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  2086ms

 Test Files  35 passed (35)
      Tests  302 passed (302)
   Start at  10:36:37
   Duration  7.35s (transform 5.88s, setup 0ms, collect 11.78s, tests 22.93s, environment 4.58s, prepare 2.24s)
