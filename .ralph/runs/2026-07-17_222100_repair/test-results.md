...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (10 tests) 1205ms
   ✓ mounted witness resource actions > captures with the exact body and refetches the canonical collection once  400ms
 ✓ src/pages/settings/SettingsHub.test.tsx (10 tests) 1483ms
 ...
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 2404ms
   ✓ default AppraisalWorkbench authenticated HTTP container > calculates a limit from entered source IDs and refreshes four reads  754ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2804ms
   ...
   ✓ MemberGovernanceForm > submits every individual registration profile field  1463ms
 ✓ src/pages/documentation/DocumentationHub.test.tsx (18 tests) 3339ms
   ✓ 008M2 documentation workspace contract > posts a server-owned approval and refetches once without optimism  543ms
   ✓ 008M2 documentation workspace contract > keeps a conflict visible with no optimistic change, retry, or refetch  1006ms
   ✓ 008M2 documentation workspace contract > submits a signed-copy upload through the opaque action and refetches once  401ms
 ...
 ✓ src/pages/registers/RegistersHub.test.tsx (8 tests) 825ms
 ...
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (39 tests) 6015ms
   ✓ SanctionWorkbench authenticated container > renders the authoritative total and replaces the queue from the next server page  604ms
   ✓ SanctionWorkbench authenticated container > keeps a newer filter authoritative while an action detail refresh finishes  839ms
   ✓ SanctionWorkbench authenticated container > keeps a newer empty filter authoritative while action submission finishes  439ms
   ✓ SanctionWorkbench authenticated container > keeps a newer denied state authoritative when an action detail refresh fails later  344ms
   ✓ SanctionWorkbench authenticated container > keeps a newer malformed state authoritative when an action detail refresh fails later  324ms
   ...
   ✓ SanctionWorkbench authenticated container > uploads three application-scoped legal files before recording bounded special-case evidence  627ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2476ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2041ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 5023ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  2992ms
 ✓ src/playwrightBrowser.test.ts (4 tests) 2ms

 Test Files  37 passed (37)
      Tests  327 passed (327)
   Start at  22:32:51
   Duration  7.90s (transform 4.28s, setup 0ms, collect 10.54s, tests 28.89s, environment 5.24s, prepare 2.66s)


Duration milliseconds: 8427
Exit code: 0
