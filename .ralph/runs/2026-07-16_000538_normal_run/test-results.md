...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 1060ms
   ✓ MP05 loan-limit display authority (006Z2 interim regression) > shows independent 400, 403, and 409 errors without retry or projection refetch  657ms
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (10 tests) 1201ms
   ✓ mounted witness resource actions > captures with the exact body and refetches the canonical collection once  426ms
 ✓ src/pages/settings/SettingsHub.test.tsx (10 tests) 1252ms
 ...
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1814ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2439ms
   ...
   ✓ MemberGovernanceForm > submits every individual registration profile field  1003ms
 ...
 ✓ src/pages/borrower/portal/documents/PortalDocumentationActions.test.tsx (8 tests) 552ms
...
(node:43315) ExperimentalWarning: buffer.File is an experimental feature and might change at any time
(Use `node --trace-warnings ...` to show where the warning was created)
 ...
 ✓ src/pages/documentation/DocumentationHub.test.tsx (1 test) 1ms
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2452ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2032ms
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (39 tests) 5140ms
   ...
   ✓ SanctionWorkbench authenticated container > keeps a newer filter authoritative while an action detail refresh finishes  369ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 3692ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  1883ms

 Test Files  36 passed (36)
      Tests  306 passed (306)
   Start at  00:43:58
   Duration  6.83s (transform 5.06s, setup 0ms, collect 9.96s, tests 22.05s, environment 3.75s, prepare 2.20s)
