...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-14_051852_normal_run/sfpcl-lms

 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 988ms
   ✓ MP05 loan-limit display authority (006Z2 interim regression) > shows independent 400, 403, and 409 errors without retry or projection refetch  591ms
 ...
 ✓ src/pages/settings/SettingsHub.test.tsx (10 tests) 1249ms
   ...
   ✓ SettingsHub remaining panels > creates a complete successor as a separate audited draft for a canonical policy manager  336ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2325ms
 ...
 ✓ src/pages/registers/RegistersHub.test.tsx (7 tests) 585ms
 ...
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (25 tests) 2804ms
 ...
 ✓ src/services/authSession.test.ts (27 tests) 37ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2591ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2190ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 3355ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  1911ms

 Test Files  33 passed (33)
      Tests  269 passed (269)
   Start at  05:55:08
   Duration  6.25s (transform 4.80s, setup 0ms, collect 8.84s, tests 18.08s, environment 3.39s, prepare 2.06s)
