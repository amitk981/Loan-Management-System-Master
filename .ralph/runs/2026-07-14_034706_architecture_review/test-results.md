...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-14_034706_architecture_review/sfpcl-lms
 ...
 ✓ src/services/authSession.test.ts (18 tests) 35ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2937ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2047ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is explicit false  446ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > exposes only approved staff demo controls when the flag is true  444ms
 ...
 ✓ src/pages/settings/SettingsHub.test.tsx (10 tests) 1234ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2458ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1109ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  1100ms
 ✓ src/pages/registers/RegistersHub.test.tsx (7 tests) 505ms
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (22 tests) 2580ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 2711ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  1473ms

 Test Files  33 passed (33)
      Tests  257 passed (257)
   Start at  04:12:03
   Duration  7.24s (transform 4.88s, setup 0ms, collect 9.04s, tests 17.13s, environment 3.40s, prepare 2.04s)
