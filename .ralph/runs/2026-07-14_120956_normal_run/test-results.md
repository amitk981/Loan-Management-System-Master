...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-14_120956_normal_run/sfpcl-lms

 ✓ src/pages/registers/RegistersHub.test.tsx (8 tests) 828ms
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 1127ms
   ✓ MP05 loan-limit display authority (006Z2 interim regression) > shows independent 400, 403, and 409 errors without retry or projection refetch  676ms
 ...
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1743ms
   ✓ default AppraisalWorkbench authenticated HTTP container > calculates a limit from entered source IDs and refreshes four reads  322ms
 ✓ src/pages/members/MemberProfile.container.test.tsx (4 tests) 273ms
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2306ms
 ...
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (10 tests) 1112ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2871ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2309ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is explicit false  311ms
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (39 tests) 5013ms
   ✓ SanctionWorkbench authenticated container > renders the authoritative total and replaces the queue from the next server page  465ms
   ...
   ✓ SanctionWorkbench authenticated container > uploads three application-scoped legal files before recording bounded special-case evidence  407ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 3584ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  2258ms

 Test Files  33 passed (33)
      Tests  293 passed (293)
   Start at  12:39:55
   Duration  7.08s (transform 5.37s, setup 0ms, collect 10.35s, tests 21.12s, environment 4.12s, prepare 2.06s)
