...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-13_090059_normal_run/sfpcl-lms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2837ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2029ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is explicit false  457ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > exposes only approved staff demo controls when the flag is true  350ms
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 832ms
   ✓ MP05 loan-limit display authority (006Z2 interim regression) > shows independent 400, 403, and 409 errors without retry or projection refetch  483ms
 ...
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1231ms
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 1730ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  982ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  590ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 2525ms
 ...
 Test Files  29 passed (29)
   ...
   Start at  09:13:31
   Duration  6.29s (transform 3.92s, setup 0ms, collect 7.24s, tests 11.38s, environment 2.24s, prepare 1.76s)
