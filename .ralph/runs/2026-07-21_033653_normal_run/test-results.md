...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 1048ms
   ✓ MP05 loan-limit display authority (006Z2 interim regression) > shows independent 400, 403, and 409 errors without retry or projection refetch  631ms
 ✓ src/pages/registers/RegistersHub.test.tsx (8 tests) 931ms
   ...
   ✓ RegistersHub owned approval register panels > applies only canonical financial-year values  341ms
 ✓ src/pages/settings/SettingsHub.test.tsx (10 tests) 1523ms
 ...
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1899ms
 ...
 ✓ src/pages/documentation/DocumentationHub.test.tsx (18 tests) 2724ms
   ✓ 008M2 documentation workspace contract > posts a server-owned approval and refetches once without optimism  557ms
   ✓ 008M2 documentation workspace contract > keeps a conflict visible with no optimistic change, retry, or refetch  497ms
   ✓ 008M2 documentation workspace contract > submits a signed-copy upload through the opaque action and refetches once  373ms
 ✓ src/pages/borrower/portal/applications/MP11_DeficiencyResponse.test.tsx (2 tests) 1015ms
   ✓ MP11 deficiency response > uploads a server-contracted response, refetches canonical state, and resubmits  920ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2700ms
   ...
   ✓ MemberGovernanceForm > submits every individual registration profile field  1021ms
 ✓ src/pages/disbursement/PaymentAuthorisationHub.test.tsx (5 tests) 1157ms
   ...
   ✓ 009K CFC payment authorisation workspace > surfaces backend duplicate UTR and permission errors without optimistic success  420ms
 ✓ src/pages/disbursement/DisbursementHub.test.tsx (4 tests) 408ms
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (10 tests) 1367ms
 ...
 ✓ src/pages/loan-accounts/LoanAccount360.test.tsx (4 tests) 238ms
 ...
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (39 tests) 6089ms
   ...
   ✓ SanctionWorkbench authenticated container > keeps a newer denied state authoritative when an action detail refresh fails later  352ms
   ✓ SanctionWorkbench authenticated container > keeps a newer malformed state authoritative when an action detail refresh fails later  585ms
   ✓ SanctionWorkbench authenticated container > keeps a newer empty state authoritative when an action detail refresh fails later  420ms
   ...
   ✓ SanctionWorkbench authenticated container > requires a reason and sends the exact Reject request  478ms
   ✓ SanctionWorkbench authenticated container > requires a reason and sends the exact Return for Clarification request  381ms
   ✓ SanctionWorkbench authenticated container > uploads three application-scoped legal files before recording bounded special-case evidence  502ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 5149ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 1110ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  1011ms

 Test Files  43 passed (43)
      Tests  355 passed (355)
   Start at  04:37:56
   Duration  9.15s (transform 4.39s, setup 0ms, collect 13.32s, tests 29.84s, environment 7.25s, prepare 3.05s)


Duration milliseconds: 10015
Exit code: 0
