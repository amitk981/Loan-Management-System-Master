...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-17_102143_normal_run/sfpcl-lms

 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 1196ms
 ...
 ✓ src/pages/settings/SettingsHub.test.tsx (10 tests) 1637ms
   ✓ SettingsHub Approval Matrix panel > renders active and retained historical rules from the versioned API without local fixtures  327ms
   ✓ SettingsHub Approval Matrix panel > permits a canonical manager to submit a complete successor version as a pending proposal  710ms
 ...
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1944ms
   ✓ default AppraisalWorkbench authenticated HTTP container > calculates a limit from entered source IDs and refreshes four reads  365ms
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2647ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1380ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  982ms
 ✓ src/pages/documentation/DocumentationHub.test.tsx (18 tests) 2708ms
 ...
 ✓ src/pages/registers/RegistersHub.test.tsx (8 tests) 787ms
 ...
 ✓ src/pages/borrower/portal/applications/MP11_DeficiencyResponse.test.tsx (2 tests) 460ms
   ✓ MP11 deficiency response > uploads a server-contracted response, refetches canonical state, and resubmits  377ms
 ...
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (39 tests) 5370ms
   ...
   ✓ SanctionWorkbench authenticated container > keeps a newer filter authoritative while an action detail refresh finishes  444ms
   ✓ SanctionWorkbench authenticated container > keeps a newer malformed state authoritative when an action detail refresh fails later  321ms
   ...
   ✓ SanctionWorkbench authenticated container > requires a reason and sends the exact Reject request  315ms
 ...
 ✓ src/pages/borrower/portal/auth/MP00_Login.test.tsx (2 tests) 25ms
 ✓ src/services/navigationPermissions.test.ts (9 tests) 10ms
 ✓ src/utils/applicationDisplay.test.ts (5 tests) 2ms
 ✓ src/contexts/RoleContext.test.tsx (2 tests) 6ms
 ✓ src/services/tracerApi.test.ts (2 tests) 4ms
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2813ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2296ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 4159ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  2224ms
 ...
 Test Files  37 passed (37)
   ...
   Start at  10:43:01
   Duration  7.88s (transform 5.22s, setup 0ms, collect 12.21s, tests 26.73s, environment 4.80s, prepare 2.30s)


Duration milliseconds: 8414
Exit code: 0
