...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-12_145438_normal_run/sfpcl-lms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2058ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  1765ms
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (3 tests) 431ms
   ✓ mounted witness resource actions > captures with the exact body and refetches the canonical collection once  338ms
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 954ms
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (4 tests) 1219ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  694ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  430ms

 Test Files  27 passed (27)
      Tests  175 passed (175)
   Start at  15:07:47
   Duration  3.60s (transform 2.56s, setup 0ms, collect 5.11s, tests 5.57s, environment 949ms, prepare 1.58s)
