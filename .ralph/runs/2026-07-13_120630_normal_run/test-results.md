...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-13_120630_normal_run/sfpcl-lms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 3316ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2403ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is explicit false  503ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > exposes only approved staff demo controls when the flag is true  409ms
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 964ms
 ...
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (10 tests) 1174ms
   ✓ mounted witness resource actions > captures with the exact body and refetches the canonical collection once  380ms
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1383ms
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 1820ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1051ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  630ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 2592ms
 ...
 Test Files  29 passed (29)
   ...
   Start at  12:23:30
   Duration  6.85s (transform 4.78s, setup 0ms, collect 8.51s, tests 12.56s, environment 2.72s, prepare 1.90s)
