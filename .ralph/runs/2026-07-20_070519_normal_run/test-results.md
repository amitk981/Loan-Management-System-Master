...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 ✓ src/pages/registers/RegistersHub.test.tsx (8 tests) 913ms
 ...
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 1244ms
   ✓ MP05 loan-limit display authority (006Z2 interim regression) > creates, submits exactly once, and canonically refetches the returned amount  375ms
 ...
 ✓ src/pages/documentation/DocumentationHub.test.tsx (18 tests) 2552ms
 ...
 ✓ src/pages/borrower/portal/documents/PortalDocumentationActions.test.tsx (8 tests) 616ms
   ✓ member portal documentation actions > renders server-owned actions and performs one canonical refetch after upload  380ms
 ...
 ✓ src/pages/disbursement/PaymentAuthorisationHub.test.tsx (5 tests) 934ms
   ...
   ✓ 009K CFC payment authorisation workspace > surfaces backend duplicate UTR and permission errors without optimistic success  367ms
 ✓ src/pages/disbursement/DisbursementHub.test.tsx (4 tests) 374ms
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2346ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1187ms
 ...
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (39 tests) 5636ms
   ✓ SanctionWorkbench authenticated container > renders the authoritative total and replaces the queue from the next server page  627ms
   ✓ SanctionWorkbench authenticated container > keeps a newer filter authoritative while an action detail refresh finishes  395ms
   ...
   ✓ SanctionWorkbench authenticated container > requires a reason and sends the exact Return for Clarification request  300ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 4449ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  2301ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 1076ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  978ms

 Test Files  43 passed (43)
      Tests  355 passed (355)
   Start at  07:33:12
   Duration  8.40s (transform 4.02s, setup 0ms, collect 12.50s, tests 27.23s, environment 5.67s, prepare 2.73s)


Duration milliseconds: 9185
Exit code: 0
