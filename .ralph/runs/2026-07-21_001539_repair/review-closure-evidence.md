...
| AC-INT3-4 | sfpcl_credit.tests.test_servicing_postgresql_acceptance.InterestPolicyIntegrityPostgreSQLAcceptanceTests.test_exact_capitalisation_race_replays_one_byte_stable_decision | evidence/terminal-logs/interest-policy-postgresql-repair-pass-1.log |
| AC-INT3-5 | sfpcl_credit.tests.test_servicing_postgresql_acceptance.InterestPolicyIntegrityPostgreSQLAcceptanceTests.test_changed_key_capitalisation_race_retains_one_reclassification | evidence/terminal-logs/interest-policy-postgresql-repair-pass-2.log |

The repair preserves the original financial-behavior evidence and adds deterministic storage
isolation evidence for both new 010H3 test classes that consume the public servicing fixture.
