...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 832ms
 ...
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (10 tests) 1076ms
   ✓ mounted witness resource actions > captures with the exact body and refetches the canonical collection once  359ms
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1337ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 1984ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1049ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  745ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 3317ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2831ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (15 tests) 7147ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback before an ordinary update readback  3155ms
   ...
   ✓ MemberGovernanceForm production container > submits the complete fpc body through the shared HTTP transport  972ms
   ✓ MemberGovernanceForm production container > submits the complete producer_institution body through the shared HTTP transport  1132ms

 Test Files  29 passed (29)
      Tests  207 passed (207)
   Start at  04:02:40
   Duration  10.26s (transform 4.49s, setup 0ms, collect 7.37s, tests 16.76s, environment 2.33s, prepare 1.79s)
