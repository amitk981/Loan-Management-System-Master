...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 954ms
 ...
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1632ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2638ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2160ms
 ✓ src/services/tracerApi.test.ts (2 tests) 3ms
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (39 tests) 4766ms
   ✓ SanctionWorkbench authenticated container > renders the authoritative total and replaces the queue from the next server page  427ms
   ...
   ✓ SanctionWorkbench authenticated container > uploads three application-scoped legal files before recording bounded special-case evidence  518ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 3408ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  2076ms

 Test Files  33 passed (33)
      Tests  293 passed (293)
   Start at  12:06:13
   Duration  6.65s (transform 4.90s, setup 0ms, collect 9.18s, tests 20.18s, environment 3.89s, prepare 2.05s)
