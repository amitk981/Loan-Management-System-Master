...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-16_025941_normal_run/sfpcl-lms

 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 1059ms
   ✓ MP05 loan-limit display authority (006Z2 interim regression) > shows independent 400, 403, and 409 errors without retry or projection refetch  594ms
 ✓ src/pages/applications/WitnessPanel.container.test.tsx (10 tests) 1253ms
   ✓ mounted witness resource actions > captures with the exact body and refetches the canonical collection once  497ms
 ✓ src/pages/settings/SettingsHub.test.tsx (10 tests) 1331ms
   ...
   ✓ SettingsHub remaining panels > creates a complete successor as a separate audited draft for a canonical policy manager  324ms
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1732ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2424ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1222ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  927ms
 ✓ src/pages/registers/RegistersHub.test.tsx (8 tests) 789ms
 ...
 ✓ src/pages/documentation/DocumentationHub.test.tsx (6 tests) 711ms
...
(node:95912) ExperimentalWarning: buffer.File is an experimental feature and might change at any time
(Use `node --trace-warnings ...` to show where the warning was created)
 ...
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (39 tests) 5092ms
   ...
   ✓ SanctionWorkbench authenticated container > keeps a newer filter authoritative while an action detail refresh finishes  363ms
   ...
   ✓ SanctionWorkbench authenticated container > uploads three application-scoped legal files before recording bounded special-case evidence  540ms
 ✓ src/services/loanPolicyApi.test.ts (2 tests) 9ms
 ✓ src/utils/applicationDisplay.test.ts (5 tests) 4ms
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2363ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  1974ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 3948ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  2126ms
   ✓ MemberGovernanceForm production container > performs one ordinary human-like update before canonical Profile readback with the exact update ledger  316ms

 Test Files  36 passed (36)
      Tests  311 passed (311)
   Start at  03:26:52
   Duration  6.88s (transform 4.74s, setup 0ms, collect 9.70s, tests 22.99s, environment 4.09s, prepare 2.15s)
