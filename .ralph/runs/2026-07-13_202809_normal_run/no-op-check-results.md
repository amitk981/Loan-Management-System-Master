...
- docs/slices/007F2-exception-routing-coherence-and-explicit-projection-closure.md
- docs/slices/007G2-general-meeting-current-evidence-and-document-scope-closure.md
- docs/slices/007H2-sanction-decision-and-register-object-scope-closure.md
- docs/working/API_CONTRACTS.md
- docs/working/HANDOFF.md
- docs/working/digests/epic-007-sanction-approval-workflow.md
- sfpcl_credit/approvals/apps.py
