...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (5 tests) 164ms
 ✓ src/pages/members/MemberProfile.container.test.tsx (4 tests) 237ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 1927ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  978ms
   ✓ MemberGovernanceForm > submits every individual registration profile field  734ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 3255ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2718ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (15 tests) 7019ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback before an ordinary update readback  3065ms
   ✓ MemberGovernanceForm production container > submits the complete individual_farmer body through the shared HTTP transport  1151ms
 ...
 Test Files  29 passed (29)
   ...
   Start at  02:52:10
   Duration  10.04s (transform 4.50s, setup 0ms, collect 7.31s, tests 15.69s, environment 2.29s, prepare 1.60s)
