...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-15_001106_normal_run/sfpcl-lms

 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 1050ms
   ✓ MP05 loan-limit display authority (006Z2 interim regression) > shows independent 400, 403, and 409 errors without retry or projection refetch  643ms
 ...
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1781ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2301ms
 ...
 ✓ src/pages/members/MemberProfile.test.tsx (26 tests) 243ms
 ✓ src/pages/registers/RegistersHub.test.tsx (8 tests) 645ms
 ...
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 2636ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2175ms
 ✓ src/services/loanPolicyApi.test.ts (2 tests) 5ms
 ✓ src/utils/applicationDisplay.test.ts (5 tests) 2ms
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (39 tests) 4779ms
   ✓ SanctionWorkbench authenticated container > renders the authoritative total and replaces the queue from the next server page  367ms
   ✓ SanctionWorkbench authenticated container > keeps a newer filter authoritative while an action detail refresh finishes  331ms
   ✓ SanctionWorkbench authenticated container > keeps a newer empty filter authoritative while action submission finishes  343ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 3508ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  2056ms

 Test Files  33 passed (33)
      Tests  293 passed (293)
   Start at  00:36:42
   Duration  6.65s (transform 4.89s, setup 0ms, collect 8.75s, tests 20.39s, environment 3.30s, prepare 1.97s)
