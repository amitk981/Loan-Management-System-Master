...
- Authoritative lane: impacted
- Classifier recommendation: impacted
- Selection reason: localized low/medium-risk backend change with explicit test modules
- Enforcement policy: selective
- Slice risk: medium
- Candidate completion ordinal: 358
...
- `sfpcl_credit.tests.test_seed_critical_uat_e2e_fixture`
