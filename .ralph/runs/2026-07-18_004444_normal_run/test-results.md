...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-18_004444_normal_run/sfpcl-lms
 ...
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1914ms
 ...
 ✓ src/pages/documentation/DocumentationHub.test.tsx (18 tests) 2656ms
   ✓ 008M2 documentation workspace contract > posts a server-owned approval and refetches once without optimism  564ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2277ms
   ✓ MemberGovernanceForm > submits the institution create variant without individual identity/profile fields  1162ms
 ...
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (39 tests) 5445ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 4282ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  2366ms
   ✓ MemberGovernanceForm production container > performs one ordinary human-like update before canonical Profile readback with the exact update ledger  305ms
   ✓ MemberGovernanceForm production container > posts only the protected identity delta through the shared HTTP transport  336ms
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 1201ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  1096ms

 Test Files  37 passed (37)
      Tests  327 passed (327)
   Start at  00:54:08
   Duration  7.62s (transform 4.28s, setup 0ms, collect 11.75s, tests 24.85s, environment 4.35s, prepare 2.45s)


Duration milliseconds: 8431
Exit code: 0
