...
[33mThe CJS build of Vite's Node API is deprecated. See https://vite.dev/guide/troubleshooting.html#vite-cjs-node-api-deprecated for more details.[39m
 ...
 RUN  v3.2.6 /Users/amitkallapa/LMS/.ralph/worktrees/2026-07-14_004058_normal_run/sfpcl-lms
 ...
 ✓ src/pages/profile/MyProfile.test.tsx (1 test) 42ms
 ✓ src/services/applicationIntakeApi.test.ts (5 tests) 9ms
 ✓ src/services/creditAssessmentApi.test.ts (5 tests) 7ms
 ✓ src/services/navigationPermissions.test.ts (8 tests) 12ms
 ✓ src/services/portalApi.test.ts (4 tests) 7ms
 ✓ src/utils/applicationDisplay.test.ts (5 tests) 2ms
 ✓ src/services/demoAuthFlag.test.tsx (3 tests) 3170ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is unset  2183ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > fails closed when the flag is explicit false  498ms
   ✓ VITE_ENABLE_DEMO_AUTH real App/RoleProvider boundary (005FA4) > exposes only approved staff demo controls when the flag is true  489ms
 ✓ src/pages/borrower/portal/applications/MP05_NewApplication.test.tsx (7 tests) 1068ms
   ✓ MP05 loan-limit display authority (006Z2 interim regression) > shows independent 400, 403, and 409 errors without retry or projection refetch  641ms
 ...
 ✓ src/pages/appraisal/AppraisalWorkbench.container.test.tsx (14 tests) 1649ms
 ...
 ✓ src/pages/members/MemberGovernanceForm.test.tsx (5 tests) 2195ms
   ...
   ✓ MemberGovernanceForm > submits every individual registration profile field  964ms
 ✓ src/pages/members/MemberProfile.container.test.tsx (4 tests) 273ms
 ✓ src/pages/sanction/SanctionWorkbench.test.tsx (21 tests) 2372ms
   ✓ SanctionWorkbench authenticated container > loads frozen case truth and approves through the exact case boundary before canonical refresh  367ms
   ...
   ✓ SanctionWorkbench authenticated container > uploads three application-scoped legal files before recording bounded special-case evidence  554ms
 ✓ src/pages/registers/RegistersHub.test.tsx (7 tests) 486ms
 ✓ src/pages/settings/SettingsHub.test.tsx (9 tests) 943ms
   ✓ SettingsHub Approval Matrix panel > permits a canonical manager to submit a complete successor version as a pending proposal  487ms
 ✓ src/pages/members/MemberGovernanceForm.container.test.tsx (16 tests) 2650ms
   ✓ MemberGovernanceForm production container > routes Directory registration into canonical Profile readback with the exact create ledger  1431ms

 Test Files  33 passed (33)
      Tests  251 passed (251)
   Start at  01:02:39
   Duration  7.15s (transform 4.70s, setup 0ms, collect 8.78s, tests 16.85s, environment 3.42s, prepare 2.06s)
